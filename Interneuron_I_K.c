...
#define nrn_init _nrn_init__interneuron_i_k
#define _nrn_initial _nrn_initial__interneuron_i_k
#define nrn_cur _nrn_cur__interneuron_i_k
#define _nrn_current _nrn_current__interneuron_i_k
#define nrn_jacob _nrn_jacob__interneuron_i_k
#define nrn_state _nrn_state__interneuron_i_k
#define _net_receive _net_receive__interneuron_i_k 
#define _f_settables _f_settables__interneuron_i_k 
#define settables settables__interneuron_i_k 
#define states states__interneuron_i_k 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_interneuron_i_k", _hoc_setdata,
 "settables_interneuron_i_k", _hoc_settables,
 "vtrap_interneuron_i_k", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_interneuron_i_k
...
#define V_T V_T_interneuron_i_k
 double V_T = -55;
#define ek ek_interneuron_i_k
 double ek = -100;
#define usetable usetable_interneuron_i_k
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_interneuron_i_k", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "ek_interneuron_i_k", "mV",
 "V_T_interneuron_i_k", "mV",
 "i_K_interneuron_i_k", "mA/cm2",
 "g_K_interneuron_i_k", "S/cm2",
 0,0
};
 ...
 "ek_interneuron_i_k", &ek_interneuron_i_k,
 "V_T_interneuron_i_k", &V_T_interneuron_i_k,
 "usetable_interneuron_i_k", &usetable_interneuron_i_k,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 interneuron_i_k c:/Users/Maria/Desktop/PhD/Code/NetPyNE_course/model/Interneuron_I_K.mod\n");
...
static int _reset;
static char *modelname = "Delayed-rectifier Potassium Current for Cortical Interneuron";
...
#if NMODL_TEXT
static const char* nmodl_filename = "Interneuron_I_K.mod";
static const char* nmodl_file_text = 
