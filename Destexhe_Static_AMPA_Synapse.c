...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _Destexhe_Static_AMPA_Synapse_reg() {
	int _vectorized = 1;
  _initlists();
 ...
 pnt_receive_size[_mechtype] = 3;
 	...
 	ivoc_help("help ?1 AMPA_S c:/Users/Maria/Desktop/PhD/Code/NetPyNE_course/model/Destexhe_Static_AMPA_Synapse.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "Destexhe_Static_AMPA_Synapse.mod";
static const char* nmodl_file_text = 
