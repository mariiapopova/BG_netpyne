...
#define nrn_init _nrn_init__cortical_soma_i_na
#define _nrn_initial _nrn_initial__cortical_soma_i_na
#define nrn_cur _nrn_cur__cortical_soma_i_na
#define _nrn_current _nrn_current__cortical_soma_i_na
#define nrn_jacob _nrn_jacob__cortical_soma_i_na
#define nrn_state _nrn_state__cortical_soma_i_na
#define _net_receive _net_receive__cortical_soma_i_na 
#define _f_settables _f_settables__cortical_soma_i_na 
#define settables settables__cortical_soma_i_na 
#define states states__cortical_soma_i_na 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cortical_soma_i_na", _hoc_setdata,
 "settables_cortical_soma_i_na", _hoc_settables,
 "vtrap_cortical_soma_i_na", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_cortical_soma_i_na
...
#define V_T V_T_cortical_soma_i_na
 double V_T = -55;
#define ena ena_cortical_soma_i_na
 double ena = 50;
#define usetable usetable_cortical_soma_i_na
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_cortical_soma_i_na", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "ena_cortical_soma_i_na", "mV",
 "V_T_cortical_soma_i_na", "mV",
 "i_Na_cortical_soma_i_na", "mA/cm2",
 "g_Na_cortical_soma_i_na", "S/cm2",
 0,0
};
 ...
 "ena_cortical_soma_i_na", &ena_cortical_soma_i_na,
 "V_T_cortical_soma_i_na", &V_T_cortical_soma_i_na,
 "usetable_cortical_soma_i_na", &usetable_cortical_soma_i_na,
 0,0
};
...
#define _cvode_ieq _ppvar[2]._i
 ...
 "7.7.0",
"cortical_soma_i_na",
 "i_Na_cortical_soma_i_na",
 "g_Na_cortical_soma_i_na",
 0,
 0,
 "m_cortical_soma_i_na",
 "h_cortical_soma_i_na",
 0,
 0};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 cortical_soma_i_na c:/Users/Maria/Desktop/PhD/Code/NetPyNE_course/model/Cortical_Soma_I_Na.mod\n");
...
static int _reset;
static char *modelname = "Sodium Current for Cortical Neuron Soma";
...
#if NMODL_TEXT
static const char* nmodl_filename = "Cortical_Soma_I_Na.mod";
static const char* nmodl_file_text = 
